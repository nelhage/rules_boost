...
cc_library(
    ...
    copts = select({
        ...
        "-Iexternal/com_github_nelhage_rules_boost~~_repo_rules~org_lzma_lzma/src/common",
        "-Iexternal/com_github_nelhage_rules_boost~~_repo_rules~org_lzma_lzma/src/liblzma",
        "-Iexternal/com_github_nelhage_rules_boost~~_repo_rules~org_lzma_lzma/src/liblzma/api",
        "-Iexternal/com_github_nelhage_rules_boost~~_repo_rules~org_lzma_lzma/src/liblzma/common",
        "-Iexternal/com_github_nelhage_rules_boost~~_repo_rules~org_lzma_lzma/src/liblzma/check",
        "-Iexternal/com_github_nelhage_rules_boost~~_repo_rules~org_lzma_lzma/src/liblzma/delta",
        "-Iexternal/com_github_nelhage_rules_boost~~_repo_rules~org_lzma_lzma/src/liblzma/lz",
        "-Iexternal/com_github_nelhage_rules_boost~~_repo_rules~org_lzma_lzma/src/liblzma/lzma",
        "-Iexternal/com_github_nelhage_rules_boost~~_repo_rules~org_lzma_lzma/src/liblzma/rangecoder",
        "-Iexternal/com_github_nelhage_rules_boost~~_repo_rules~org_lzma_lzma/src/liblzma/simple",
    ],
    defines = select({
